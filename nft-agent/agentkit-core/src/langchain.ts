...
import type { Agentkit, AgentkitAction } from "./agentkit";
...
export class AgentkitToolkit extends Toolkit {
	...
	constructor(agentkit: Agentkit) {
		super();
		this.tools = AGENTKIT_ACTIONS.map(
			(action) => new AgentkitTool(action, agentkit),
		);
	}
...
export class AgentkitTool<
	TActionSchema extends ActionSchemaAny,
