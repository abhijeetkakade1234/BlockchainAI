...
export function NFTGallery({ isDarkMode, toggleDarkMode, onNavigateBack, onNavigateToChat, onNavigateToSettings }: NFTGalleryProps) {
    ...
    <div className="h-full flex flex-col bg-sidebar border-r border-sidebar-border">
      ...
      <nav className="flex-1 p-2">
        {[
          ...
          { id: 'portfolio', label: 'Portfolio', icon: BarChart3, onClick: () => console.log('Portfolio clicked - already here') },
