...
export function SettingsPage({ isDarkMode, toggleDarkMode, onNavigateBack, onNavigateToChat, onNavigateToNFTs }: SettingsPageProps) {
    ...
    <div className="h-full flex flex-col bg-sidebar border-r border-sidebar-border">
      ...
      <nav className="flex-1 p-2">
        {[
          ...
          { id: 'portfolio', label: 'Portfolio', icon: BarChart3, onClick: () => console.log('Portfolio clicked - navigate from settings') },
          { id: 'transactions', label: 'Transactions', icon: Activity, onClick: () => console.log('Transactions clicked - feature coming soon') },
